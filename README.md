...
```bash
composer require mantonio84/laravel-bootstrap-4-forms
```
...
'providers' => [
    //...
	mantonio84\Bootstrap4Forms\Bootstrap4FormsServiceProvider::class,
],
```
...
'aliases' => [
    //...
    'Form' => mantonio84\Bootstrap4Forms\Bootstrap4FormsFacade::class,
],
```
